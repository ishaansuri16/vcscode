...
import { WalletHistoryComponent } from 'app/entities/wallet-history/wallet-history.component';
...
describe('Component Tests', () => {
    describe('WalletHistory Management Component', () => {
        let comp: WalletHistoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WalletHistoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.walletHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
